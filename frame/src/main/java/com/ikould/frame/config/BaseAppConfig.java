...
public class BaseAppConfig {
    ...
    static {
        ROOT_DIR = Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + "Android" + File.separator + "data" + File.separator + "com.ikould.daily" + File.separator + "Files";
